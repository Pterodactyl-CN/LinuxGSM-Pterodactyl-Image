...
RUN  apt update -y 
RUN  apt -y install mailutils postfix curl wget file bzip2 gzip unzip libcurl4-openssl bsdmainutils python util-linux ca-certificates binutils bc tmux lib32gcc1 libstdc++6 libstdc++6:i386 lib32tinfo5 lib32z1 sudo		
RUN apt-get clean		
